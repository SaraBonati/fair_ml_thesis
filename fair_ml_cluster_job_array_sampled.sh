...
#SBATCH --job-name=fair_ml_thesis_sampled
#SBATCH --mail-user=sarab23@zedat.fu-berlin.de
#SBATCH --mail-type=end
#SBATCH --output=/home/sarab23/fair_ml/fair_ml_thesis_logs/new_aif_sampling1/sampling-%A_%a.out
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# run script
# sklearn
python models/sklearn_models_cluster_sampling.py  --mode ${mode} --train ${train} --year ${year}
# aif360
python models/aif360_models_cluster_sampling.py  --mode ${mode} --train ${train} --year ${year}